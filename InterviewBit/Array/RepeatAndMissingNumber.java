...
public class Solution 
{
    public int[] repeatedNumber(final int[] A) 
    {
        ...
        {
            actualSum += A[i];
            actualSquareSum += (long)A[i]*(long)A[i];
        }

        long a_minus_b = actualSum - sum;
        long a_square_minus_b_square = actualSquareSum - squareSum;
        long a_plus_b = a_square_minus_b_square/a_minus_b;

        long a = (a_minus_b + a_plus_b)/2;
        long b = a_plus_b - a;
